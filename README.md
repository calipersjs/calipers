...
**Note**: Currently supports node 0.10, but not 0.12, due to the dependence on poppler-simple which is [not yet supporting 0.12](https://github.com/blackbeam/poppler-simple/issues/5).
